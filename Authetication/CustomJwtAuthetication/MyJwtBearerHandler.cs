...
{
    public class MyJwtBearerHandler : AuthenticationHandler<MyJwtBearerOptions>
    {
        private OpenIdConnectConfiguration _configuration;

        public MyJwtBearerHandler(IOptionsMonitor<MyJwtBearerOptions> options, ILoggerFactory logger, UrlEncoder encoder,
            ISystemClock clock)
